 ...
 * 
 */
package com.collaborative.gsuite.collaborativegsuite.controller;
...
public class HomepageController {
	...
	//@Value(value = "google.oauth.callback.uri")
	@Value("${google.oauth.callback.uri}")
	private String CALLBACK_URI;

	//@Value(value = "google.secret.key.path")
	@Value("${google.secret.key.path}")
	private Resource gdSecretKeys;

	//@Value(value = "google.credentials.folder.path")
	@Value("${google.credentials.folder.path}")
	private Resource credentialsFolder;
	
	//@Value(value = "google.service.account.key")
